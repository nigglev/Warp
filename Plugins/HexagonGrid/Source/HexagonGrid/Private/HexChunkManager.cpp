...
void UFHexChunkManager::OnCellChange(const HexMath::FAxialCoord& InAxialCoord, const FCellLayers& InCell)
{
	...
	if (ChunkIndex != INDEX_NONE)
	{
		ChunksList_[ChunkIndex].ChunkActor->OnCellChange(InOffsetCoord, InCell);
	}
}